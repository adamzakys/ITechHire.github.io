             ...
             <div class="loginbox">
                 <div class="loginclient">
                     <form action="" method="post">
                         ...
                         <p>Masuk sebagai Perusahaan <a href="Login_perusahaan.php">Klik Disini!</a></p>
                ...
                if(isset($_POST['login'])) {
                    ...
                    $qry = mysqli_query($conn,"SELECT * FROM akun_kandidat WHERE email = '$email' AND password = md5 ('$password')");
                ...
                ?>
                 ...
                 <div class="loginadmin">
                     <form action="">
                         ...
                         <p>
                             <input type="submit" name="login_admin" id="submit" value="Masuk">
                         </p>
                     </form>
                 </div>
                ...
                if(isset($_POST['login_admin'])) {
                    ...
                    $qry2 = mysqli_query($conn,"SELECT * FROM akun_admin WHERE email = '$email2' AND password = md5 ('$password')");
                    $cek2 = mysqli_num_rows($qry2);
                    if ($cek==1) {
                        $_SESSION['userweb']=$email2;
                        header("location:Regis_kandidat.php");
                        exit;
                    }
                    else {
