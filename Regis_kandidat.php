...
<body>
    ...
    <div class="topwrapper">
        <div class="container">
            <h2 style="border-bottom: 2px solid #112B3C ;">Pencari kerja</h2>
            <div class="isi" align="center">
                <div class="container">
                    <div class="main">
                        <div class="form">
                            <form action="" method="post">
                                <h2 style="text-align: center;">Daftar Sebagai Pencari Kerja</h2>
                        ...
                        <div class="gm">
                            <img src="image/daftargm.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    if (isset($_POST['submit'])) {
        if(registrasi_kandidat($_POST) > 0 ){
            echo "<script>
